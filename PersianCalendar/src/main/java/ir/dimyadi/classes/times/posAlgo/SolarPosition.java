...
////////////////////////////////////////////////////////////////
    ...
    private static byte Y_COUNT;
    private final double SUNRADIUS = 0.26667;
    private final byte FAJR = 0;
    private final byte SUNRISE = 1;
    private final byte SUNTRANSIT = 2;
    private final byte ASR_SHAFI = 3;
    private final byte ASR_HANEFI = 4;
    private final byte SUNSET = 5;
    private final byte ISHA = 6;
    private final byte FAJR_ = 0;
    private final byte ISRAK = 1;
    private final byte SUNTRANSIT_ = 2;
    private final byte ASRHANEFI = 3;
    private final byte ISFIRAR = 4;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     */
    private static double greenwichSiderealTime(double ν0, double Δψ, double ε) {
    ...
    private double earthHeliocentricLongitude(double jme) {
        byte l_COUNT = (byte) LTERMS.length;
    ...
    private double earthRadiusVector(double jme) {
        byte r_COUNT = (byte) RTERMS.length;
    ...
    private double earthHeliocentricLatitude(double jme) {
        byte b_COUNT = (byte) BTERMS.length;
