...
import ir.dimyadi.classes.conversion.phaseEvents.MoonPhases;
...
public class AstroLib {
     ...
     * is a 10-day gap between the Astrolib and Gregorian ir.dimyadi.calendar where the
     * Astrolib ir.dimyadi.calendar ends on October 4, 1582 (JD = 2299160), and after
     * 10-days the Gregorian ir.dimyadi.calendar starts on October 15, 1582
     *
    ...
    /**
     * Converts a Astrolib day to a ir.dimyadi.calendar date ref: Numerical Recipes in C,
    ...
    /**
     * Converts a julian day to a ir.dimyadi.calendar date
     *
     * @param julianday
