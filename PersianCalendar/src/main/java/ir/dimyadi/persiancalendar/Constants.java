...
public class Constants {
    ...
    public static final String JSON_PARSER_URL = "http://dimyadi.ir/android/persiancalendar/data.json";
    ...
    public static final String PREF_UP_DATE = "UpDate";
    public static final String PREF_TESTAMENT = "Testament";
    public static final String PREF_TESTAMENT_CODE = "TestamentCode";
    ...
    public static final boolean DEFAULT_UP_DATE = false;
    public static final boolean DEFAULT_TESTAMENT = true;
    public static final String DEFAULT_TESTAMENT_CODE = "506";
    ...
    public static final String FONT_TAGHIBAT = "fonts/BNAZANIN.TTF";
    public static final String FONT_TODAYDUA = "fonts/BNAZANIN.TTF";
    public static final String FONT_ZEKRROZ = "fonts/BNAZANIN.TTF";
